...
# Target english.bin instead of russian.bin (proven to not crash)
ENG_OFFSET = 13786335
...
print(f"Injected {replaced} Cyrillic-encoded Thai strings into english.bin.")
...
if comp_len <= ENG_COMP_SIZE:
    ...
    print("DEPLOYED TO english.bin SUCCESSFULLY!")
else:
    ...
    print("DEPLOYED TO english.bin SUCCESSFULLY (with spacing)!")
