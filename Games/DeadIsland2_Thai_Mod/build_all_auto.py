...
def main():
    ...
    # Run PyInstaller
    run_command('pyinstaller --onefile --noconsole --add-data "fonts_en.uasset;." --add-data "pakchunk_default-WindowsNoEditor_Thai_P.pak;." -n DeadIsland2_Thai_Installer installer.py', cwd=release_dir)
