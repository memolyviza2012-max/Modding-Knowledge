# -*- coding: utf-8 -*-
"""
run_translation_DI2.py
========================
สคริปต์แปลภาษาอัตโนมัติสำหรับเกม Dead Island 2 ด้วย DeepSeek API
...
CSV_FILEPATH = r".\Translation\Game_th.csv"

# คำหยาบ Canary ตรวจจับ AI หลอน
CANARY_WORDS = ["กีวางไร่อะ", "หลอนยา", "มั่วซั่ว"]

# ==============================================================================
# [ส่วนที่ 2: Master Prompt ระดับเซียนสำหรับจักรวาล Dead Island 2 (Hell-A)]
# ==============================================================================
...
- Atmosphere: Satirical, dark humor, bloody, action-oriented, gritty, and pulp-apocalyptic.
- Swearing & Exclamations: High use of swearing and exclamations! Characters are survivors, gangsters, celebrities, and average people in Hell-A. Use natural, modern, and gritty Thai swearing matching the character's personality.
  * For common swears use: ไอ้สัส, ไอ้เหี้ย, บ้าเอ๊ย, ฉิบหาย, แม่ง.
  * Adjust based on character (e.g., gangster/rough characters use "กู/มึง", classy/polite characters use polite forms).
...
def main():
    print("=" * 60)
    print("      Dead Island 2 - Ultimate Translation Engine")
    print("=" * 60)
    ...
    for row_idx, row in enumerate(csv_rows):
        ...
        namespace = row[0]
        if 'DA_UIKeyNamesData' in namespace or source_text.lower() in ['enter', 'esc', 'escape', 'shift', 'ctrl', 'alt', 'tab', 'caps lock', 'backspace', 'space', 'spacebar']:
            row[4] = source_text # ใช้ชื่อปุ่มเดิม ไม่ต้องแปล
            continue
