...
2. **ระบบตัวกรองและค้นหาความเร็วสูง (Instant Filters & Search):**
   ...
   * **ตัวกรองไฟล์ (File Selector):** เลือกว่าจะดูเฉพาะไฟล์ที่เลือก หรือกางดูทุกไฟล์ในโปรเจกต์พร้อมกัน
   * **ระบบแบ่งหน้า (Smart Pagination):** เลือกแสดงผล 50, 100, 250 หรือทั้งหมด เพื่อคงความลื่นไหลระดับ 60 FPS แม้โปรเจกต์จะมีข้อความหลักหมื่นบรรทัด
