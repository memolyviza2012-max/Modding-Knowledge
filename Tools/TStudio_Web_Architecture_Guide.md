...
1. **แถบสรุปสดบนหน้าแรก (`PortalView.tsx: Live Community & Traffic Pulse Bar`):**
   * แสดงป้ายไฟเขียวกระพริบ `🟢 {onlineCount} คนกำลังออนไลน์สด`
   ...
   * มีปุ่มทางลัด `ดูสถิติเต็ม ↗` เพื่อเปิดหน้าต่างวิเคราะห์
